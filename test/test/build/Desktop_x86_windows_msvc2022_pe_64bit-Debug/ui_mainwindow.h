...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(addressEdit, 0, 0, 1, 1);

        btnGo = new QPushButton(centralwidget);
        btnGo->setObjectName("btnGo");

        gridLayout->addWidget(btnGo, 0, 1, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btnGo->setText(QCoreApplication::translate("MainWindow", "\347\241\256\345\256\232", nullptr));
        btnRefresh->setText(QCoreApplication::translate("MainWindow", "\346\233\264\346\226\260", nullptr));
